function [dim,f1,f2,f3,f4,f5,f6,S0,Su,St,Sd] = Ex_BC2D_Zamani21(vars,ra)
...
elseif ra == 1
    S0 = @(x1,x2,x3,x4,x5,x6) (x1-0.3)^2+(x2-1.5)^2-0.5^2;
    Su = @(x1,x2,x3,x4,x5,x6) 1.5^2-x2^2;
    St = @(x1,x2,x3,x4,x5,x6) 9*(x1+0)^2+(x2+0)^2-0.3;%0.2^2
    Sd = @(x1,x2,x3,x4,x5,x6) 9*(x1+0)^2+(x2+0)^2-3^2;
end
